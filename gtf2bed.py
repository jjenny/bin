...
def printbedline(estart,eend,field,nline):
	try:
		...
		print(strl+'\t'+strs);
	except ValueError: print('Error: non-number fields at line '+str(nline),file=sys.stderr);
...
#		pass;
	...
	#if prevtransid!='' and transid!='' and transid != prevtransid:
